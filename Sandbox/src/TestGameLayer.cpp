...
void TestGameLayer::OnUpdate(Engine::Timestep deltaTime)
{
	...
	// ------------------------------------------------------------------------------------------------------
	{
		ENGINE_PROFILE_SCOPE("Update section in TestGameLayer::OnUpdate");
		...
		{
			ENGINE_PROFILE_SCOPE("m_CameraController.OnUpdate in TestGameLayer::OnUpdate");
	...
	// ------------------------------------------------------------------------------------------------------
	{
		ENGINE_PROFILE_SCOPE("Renderer draw calls section in TestGameLayer::OnUpdate");
